...
public abstract class Win {
  ...
  /* Audable fadeOut(double seconds);
    ...
    public static void onLeftKey(DefaultKeyEvent handler) {
        dojoPane.onLeftKey(handler);
    }

    public static void onRightKey(DefaultKeyEvent handler) {
        dojoPane.onRightKey(handler);
    }

    public static void onUpKey(DefaultKeyEvent handler) {
        dojoPane.onUpKey(handler);
    }

    public static void onDownKey(DefaultKeyEvent handler) {
        dojoPane.onDownKey(handler);
    }

    public static void onSpaceKey(DefaultKeyEvent handler) {
    ...
    public static void onEscapeKey(DefaultKeyEvent handler) {
        dojoPane.onEscapeKey(handler);
    }

    public static void onEnterKey(DefaultKeyEvent handler) {
